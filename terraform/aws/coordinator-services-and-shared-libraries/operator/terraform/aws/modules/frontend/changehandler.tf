...
resource "aws_s3_object_copy" "change_handler_lambda_s3_jar" {
  bucket      = aws_s3_bucket.lambda_package_storage.id
  key         = "app/change_handler_lambda.jar"
  source      = "${var.artifacts_s3}${var.change_handler_lambda_local_jar}"
}

resource "aws_s3_object_copy" "change_handler_lambda_s3_jar_hash" {
  bucket       = aws_s3_bucket.lambda_package_storage.id
  key          = "app/change_handler_lambda.jar.hash"
  source       = "${var.artifacts_s3}${var.change_handler_lambda_local_jar}.hash"
  content_type = "text/plain"
}

data "aws_s3_bucket_object" "change_handler_lambda_s3_jar_hash" {
  depends_on  = [aws_s3_object_copy.change_handler_lambda_s3_jar_hash]
  bucket      = aws_s3_bucket.lambda_package_storage.id
  key         = "app/change_handler_lambda.jar.hash"
}
...
resource "aws_lambda_function" "change_handler_lambda" {
  ...
  source_code_hash = data.aws_s3_bucket_object.change_handler_lambda_s3_jar_hash.body
...
resource "aws_s3_object_copy" "dlq_cleanup_lambda_s3_jar" {
  bucket      = aws_s3_bucket.lambda_package_storage.id
  key         = "app/failed_job_queue_write_cleanup_lambda.jar"
  source      = "${var.artifacts_s3}${var.cleanup_lambda_local_jar}"
}

resource "aws_s3_object_copy" "dlq_cleanup_lambda_s3_jar_hash" {
  bucket       = aws_s3_bucket.lambda_package_storage.id
  key          = "app/failed_job_queue_write_cleanup_lambda.jar.hash"
  source       = "${var.artifacts_s3}${var.cleanup_lambda_local_jar}.hash"
  content_type = "text/plain"
}

data "aws_s3_bucket_object" "dlq_cleanup_lambda_s3_jar_hash" {
  depends_on  = [aws_s3_object_copy.dlq_cleanup_lambda_s3_jar_hash]
  bucket      = aws_s3_bucket.lambda_package_storage.id
  key         = "app/failed_job_queue_write_cleanup_lambda.jar.hash"
}
...
resource "aws_lambda_function" "dlq_cleanup_lambda" {
  ...
  source_code_hash = data.aws_s3_bucket_object.dlq_cleanup_lambda_s3_jar_hash.body
